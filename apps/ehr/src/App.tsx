...
import { FormTemplateMappingPage } from './features/form-templates/FormTemplateMappingPage';
            ...
            {currentUser?.hasRole([RoleType.Administrator, RoleType.Manager, RoleType.CustomerSupport]) && (
              <>
                ...
                <Route element={<AdminLayout />}>
                  ...
                  <Route path="/admin/form-templates/:templateId/mapping" element={<FormTemplateMappingPage />} />
