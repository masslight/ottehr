...
exports.dataTestIds = {
    ...
    cssHeader: {
        ...
        switchModeButton: function (status) { return "switch-status-to-".concat(status); },
        intakePractitionerInput: 'intake-practitioner-input',
        providerPractitionerInput: 'provider-practitioner-input',
    },
    dashboard: {
        appointmentsTable: function (tab) { return "appointments-table-".concat(tab); },
        ...
        tableRowWrapper: function (appointmentId) { return "appointments-table-row-".concat(appointmentId); },
        tableRowStatus: function (appointmentId) { return "appointments-table-row-status-".concat(appointmentId); },
    ...
    statesPage: {
        ...
        stateRow: function (stateValue) { return "state-row-".concat(stateValue); },
    },
    editState: {
        saveChangesButton: 'save-changes-button',
        cancelButton: 'cancel-button',
    ...
    patients: {
        ...
        searchResultRow: function (patientId) { return "".concat(exports.dataTestIds.patients.searchResultsRowPrefix).concat(patientId); },
    },
    employeesPage: {
        ...
        roleRow: function (employeeRole) { return "employee-".concat(employeeRole, "-role"); },
        ...
        qualificationRow: function (code) { return "employee-".concat(code, "-qualification"); },
    ...
    telemedEhrFlow: {
        ...
        trackingBoardLocationsSelectOption: function (id) { return "telemed-tracking-board-location-select-option-".concat(id); },
        telemedAppointmentsTabs: function (tab) { return "telemed-appointments-tabs-".concat(tab); },
        trackingBoardTableGroupRow: "telemed-tracking-board-table-group-row",
        trackingBoardTableRow: function (appointmentId) { return "telemed-tracking-board-table-row-".concat(appointmentId); },
        ...
        trackingBoardViewButton: function (appointmentId) {
            return "telemed-tracking-board-view-appointment-button-".concat(appointmentId);
        },
        trackingBoardChatButton: function (appointmentId) {
            return "telemed-tracking-board-chat-appointment-button-".concat(appointmentId);
        },
        ...
        hpiCurrentMedicationsList: function (listType) {
            return "telemed-hpi-current-medications-list-".concat(listType);
        },
        hpiCurrentMedicationsListItem: function (listDataTestId) { return "".concat(listDataTestId, "-item"); },
        ...
        hpiAdditionalQuestions: function (questionSymptom) { return "telemed-additional-questions-".concat(questionSymptom); },
        hpiAdditionalQuestionsPatientProvided: function (questionSymptom) {
            return "telemed-additional-questions-patient-provided-".concat(questionSymptom);
        },
        ...
        examTabField: function (field) { return "telemed-exam-tab-field-".concat(field); },
        examTabCards: function (card) { return "telemed-exam-tab-cards-".concat(card); },
        ...
        examTabCardsComments: function (card) { return "telemed-exam-tab-cards-comment-".concat(card); },
        videoRoomContainer: 'telemed-video-room-container',
        endVideoCallButton: 'telemed-end-video-call-button',
        appointmentVisitTabs: function (tab) { return "telemed-appointment-visit-tab-".concat(tab); },
        ...
        planTabDispositionToggleButton: function (buttonName) {
            return "telemed-plan-tab-disposition-toggle-button-".concat(buttonName);
        },
        ...
        reviewTabAdditionalQuestion: function (questionSymptom) {
            return "telemed-review-tab-additional-question-".concat(questionSymptom);
        },
    ...
    sideMenu: {
        ...
        sideMenuItem: function (item) { return "menu-item-".concat(item); },
    },
    cssModal: {
    ...
    billingContainer: {
        ...
        deleteCptCodeButton: function (code) { return "billing-container-delete-cpt-code-button-".concat(code); },
        cptCodeEntry: function (code) { return "cpt-code-entry-".concat(code); },
    },
    patientInfoPage: {
    ...
    orderMedicationPage: {
        inputField: function (field) { return "input-".concat(field); },
