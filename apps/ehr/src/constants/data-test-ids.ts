...
export const dataTestIds = {
  ...
  scribeRecommendations: {
    ...
    transcriptInput: 'scribe-transcript-input',
    useSampleButton: 'scribe-use-sample-button',
    analyzeButton: 'scribe-analyze-button',
    editTranscriptButton: 'scribe-edit-transcript-button',
    stage: (name: string) => `scribe-stage-${name}`,
    narrative: 'scribe-narrative',
    narrativeSpan: (id: string) => `scribe-narrative-span-${id}`,
    narrativePopover: (id: string) => `scribe-narrative-popover-${id}`,
    chartButton: 'scribe-chart-button',
    chartSummary: 'scribe-chart-summary',
