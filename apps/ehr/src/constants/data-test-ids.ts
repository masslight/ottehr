...
export const dataTestIds = {
  ...
  scribeRecommendations: {
    ...
    rowDetailButton: (id: string) => `scribe-row-detail-button-${id}`,
    rowDetail: (id: string) => `scribe-row-detail-${id}`,
    rowEditButton: (id: string) => `scribe-row-edit-${id}`,
    rowEditInput: (id: string) => `scribe-row-edit-input-${id}`,
    rowEditSaveButton: (id: string) => `scribe-row-edit-save-${id}`,
    rowEditCancelButton: (id: string) => `scribe-row-edit-cancel-${id}`,
    ...
    orderDetailButton: (id: string) => `scribe-order-detail-button-${id}`,
    orderDetail: (id: string) => `scribe-order-detail-${id}`,
