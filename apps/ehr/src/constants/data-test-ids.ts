...
export const dataTestIds = {
  ...
  telemedEhrFlow: {
    ...
    examTabField: (field: string) => `telemed-exam-tab-field-${field}`,
    examTabCards: (card: string) => `telemed-exam-tab-cards-${card}`,
    ...
    examTabCardsComments: (card: string) => `telemed-exam-tab-cards-comment-${card}`,
