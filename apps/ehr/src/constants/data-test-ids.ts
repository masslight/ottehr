...
export const dataTestIds = {
  ...
  documentProcedurePage: {
    ...
    lacerationWoundRow: (siteKey: string, index: number) => `laceration-wound-${siteKey}-${index}`,
    lacerationAddWoundButton: (siteKey: string) => `laceration-add-wound-${siteKey}`,
    lacerationWoundDetailsToggle: (siteKey: string, index: number) => `laceration-wound-details-${siteKey}-${index}`,
    ...
    requiredDocumentationList: 'required-documentation-list',
    diagnosis: 'diagnosis',
