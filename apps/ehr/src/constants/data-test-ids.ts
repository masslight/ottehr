...
export const dataTestIds = {
  ...
  dashboard: {
    ...
    dateFromFilter: 'tracking-board-date-from-filter',
    dateToFilter: 'tracking-board-date-to-filter',
  ...
  sendFaxDialog: {
    ...
    visitSelect: 'send-fax-dialog-visit-select',
    documentCheckbox: (documentType: string) => `send-fax-dialog-document-${documentType}`,
    recipientNameInput: (index: number) => `send-fax-dialog-recipient-name-${index}`,
    organizationInput: (index: number) => `send-fax-dialog-organization-${index}`,
    faxNumberInput: (index: number) => `send-fax-dialog-fax-number-${index}`,
    phoneNumberInput: (index: number) => `send-fax-dialog-phone-number-${index}`,
    removeRecipientButton: (index: number) => `send-fax-dialog-remove-recipient-${index}`,
    addRecipientButton: 'send-fax-dialog-add-recipient',
    sendButton: 'send-fax-dialog-send',
    cancelButton: 'send-fax-dialog-cancel',
  },
  hpiAndTemplatesPage: {
    hpiTitle: 'hpi-title',
    hpiNotes: 'hpi-notes',
