...
var InternalNotes = function (_a) {
    ...
    var notesCount = (_c = (_b = data === null || data === void 0 ? void 0 : data.notes) === null || _b === void 0 ? void 0 : _b.length) !== null && _c !== void 0 ? _c : 0;
    return (<>
      <RoundedButton_1.ButtonRounded variant="outlined" startIcon={icon} onClick={openModal} sx={{
            '& .button-text': {
                display: 'none',
...
//# sourceMappingURL=InternalNotes.js.map