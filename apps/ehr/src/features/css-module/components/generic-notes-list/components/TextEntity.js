    ...
    return (<>
      <BoxStyled_1.BoxStyled>
        ...
        <material_1.Box sx={{ minWidth: '72px', py: 1 }}>
          <material_1.IconButton size="small" aria-label="edit" sx={{ color: theme.palette.primary.dark }}>
            <icons_material_1.EditOutlined fontSize="small" onClick={openEditModal}/>
