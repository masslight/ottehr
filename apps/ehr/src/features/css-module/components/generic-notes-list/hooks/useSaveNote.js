...
var useSaveNote = function (_a) {
    var _b;
    var encounterId = _a.encounterId, patientId = _a.patientId, apiConfig = _a.apiConfig;
    ...
    var handleSave = (0, react_1.useCallback)(function (text) { return __awaiter(void 0, void 0, void 0, function () {
        var newNote, saveResult, savedData, result;
        var _a;
        var _b, _c, _d, _e, _f;
            ...
            switch (_g.label) {
                case 0:
                    ...
                    newNote = {
                        type: apiConfig.type,
                        text: text,
                        authorId: (_d = (_c = (_b = user.profile) === null || _b === void 0 ? void 0 : _b.split('/')) === null || _c === void 0 ? void 0 : _c[1]) !== null && _d !== void 0 ? _d : 'unknown',
                        authorName: user.userName,
                        patientId: patientId,
                        encounterId: encounterId,
                    };
                    return [4 /*yield*/, ((_e = apiClient === null || apiClient === void 0 ? void 0 : apiClient.saveChartData) === null || _e === void 0 ? void 0 : _e.call(apiClient, (_a = {
                                encounterId: encounterId
                            },
                            _a[apiConfig.fieldName] = [newNote],
                            _a)))];
                case 1:
                    saveResult = _g.sent();
                    savedData = (_f = saveResult === null || saveResult === void 0 ? void 0 : saveResult.chartData) === null || _f === void 0 ? void 0 : _f[apiConfig.fieldName];
                    if (!savedData) return [3 /*break*/, 3];
                    result = queryClient.setQueryData(cacheKey, function (oldData) {
                        ...
                        if (oldData === null || oldData === void 0 ? void 0 : oldData[apiConfig.fieldName]) {
                            return __assign(__assign({}, oldData), (_a = {}, _a[apiConfig.fieldName] = __spreadArray(__spreadArray([], savedData, true), oldData[apiConfig.fieldName], true), _a));
                        }
                        return oldData;
                    });
