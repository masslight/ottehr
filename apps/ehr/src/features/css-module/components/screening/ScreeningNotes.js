...
exports.ScreeningNotes = void 0;
var utils_1 = require("utils");
var GenericNoteList_1 = require("../generic-notes-list/GenericNoteList");
var screeningNotesConfig = {
    apiConfig: {
        fieldName: 'notes',
        type: utils_1.NOTE_TYPE.SCREENING,
        searchParams: {
            _sort: '-_lastUpdated',
            _count: 1000,
            _tag: "".concat(utils_1.PRIVATE_EXTENSION_BASE_URL, "/").concat(utils_1.NOTE_TYPE.SCREENING, "|").concat(utils_1.CSS_NOTE_ID),
        },
    },
    locales: {
...
var ScreeningNotes = function () { return (<GenericNoteList_1.GenericNoteList apiConfig={screeningNotesConfig.apiConfig} locales={screeningNotesConfig.locales}/>); };
exports.ScreeningNotes = ScreeningNotes;
//# sourceMappingURL=ScreeningNotes.js.map