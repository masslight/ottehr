...
var VitalsHeartbeatCard = function (_a) {
    var _b;
    ...
    var _c = (0, react_1.useState)(''), heartbeatValueText = _c[0], setHeartbeatValueText = _c[1];
    ...
    var _e = (0, react_1.useState)(false), isHeartbeatValidationError = _e[0], setHeartbeatValidationError = _e[1];
    ...
    var isDisabledAddButton = !heartbeatValueText || isHeartbeatValidationError;
    var latestHeartbeatValue = (_b = currentObs[0]) === null || _b === void 0 ? void 0 : _b.value;
    var handleSaveHeartbeatObservation = function (heartbeatValueText) { return __awaiter(void 0, void 0, void 0, function () {
        var heartbeatValueNumber, observationMethod, vitalObs, _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    heartbeatValueNumber = (0, helpers_1.textToHeartbeatNumber)(heartbeatValueText);
                    if (!heartbeatValueNumber)
                        return [2 /*return*/];
                    observationMethod = (0, utils_1.toVitalHeartbeatObservationMethod)(observationQualifier);
                    _b.label = 1;
                case 1:
                ...
                case 3:
                    _a = _b.sent();
                    (0, notistack_1.enqueueSnackbar)('Error saving Heartbeat data', { variant: 'error' });
                    return [3 /*break*/, 5];
                case 4:
                    setIsSaving(false);
                    return [7 /*endfinally*/];
    ...
    var renderQualifierDropdown = function () {
        ...
        <material_1.Select value={observationQualifier} label="Qualifier" labelId="qualifier-label" variant="outlined" error={false} defaultValue="" onChange={function (event) {
          ...
          {Object.values(utils_1.VitalHeartbeatObservationMethod).map(function (obsMethod) { return (<material_1.MenuItem key={obsMethod} value={obsMethod}>
              <material_1.Typography color="textPrimary" sx={{ fontSize: '16px' }}>
                {obsMethod}
              </material_1.Typography>
            </material_1.MenuItem>); })}
    ...
    return (<material_1.Box sx={{ mt: 3 }}>
      <components_1.AccordionCard label={"HR (/min) ".concat(latestHeartbeatValue !== null && latestHeartbeatValue !== void 0 ? latestHeartbeatValue : '')} collapsed={isCollapsed} onSwitch={handleSectionCollapse}>
        <components_1.DoubleColumnContainer divider leftColumn={<material_1.Grid container sx={{
              ...
              <material_1.Grid item xs={12} sm={4} md={4} lg={4} order={{ xs: 1, sm: 1, md: 1 }}>
                <VitalsTextInputFiled_1.VitalsTextInputFiled label="HR (/min)" value={heartbeatValueText} disabled={isSaving} isInputError={isHeartbeatValidationError} onChange={handleTextInputChange}/>
              </material_1.Grid>
              ...
              <material_1.Grid item xs={12} sm={4} md={4} lg={4} order={{ xs: 3, sm: 3, md: 3, lg: 3 }} sx={{ mt: 0 }}>
                <RoundedButton_1.RoundedButton size="small" disabled={isDisabledAddButton} loading={isSaving} onClick={function () { return handleSaveHeartbeatObservation(heartbeatValueText); }} color="primary" sx={{
                height: '40px',
                px: 2,
                ml: 1,
            }}>
...
exports.default = VitalsHeartbeatCard;
//# sourceMappingURL=VitalsHeartbeatCard.js.map