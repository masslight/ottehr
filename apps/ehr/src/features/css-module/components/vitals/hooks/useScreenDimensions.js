...
var useScreenDimensions = function () {
    ...
    var isExtraLargeScreen = (0, material_1.useMediaQuery)(theme.breakpoints.up('xl'));
    // screen size size is large (lg) or larger
    var isLargeScreen = (0, material_1.useMediaQuery)(theme.breakpoints.up('lg'));
    // Check if screen size is medium (md) or larger
    var isMediumScreen = (0, material_1.useMediaQuery)(theme.breakpoints.up('md'));
    // Check if screen size is small (sm) or larger
    var isSmallScreen = (0, material_1.useMediaQuery)(theme.breakpoints.up('sm'));
    // Check if screen size is extra-small (xs)
    var isExtraSmallScreen = (0, material_1.useMediaQuery)(theme.breakpoints.down('xs'));
    // useEffect(() => {
    //   console.log(
