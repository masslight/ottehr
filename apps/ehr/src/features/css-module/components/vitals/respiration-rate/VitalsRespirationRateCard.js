...
var VitalsRespirationRateCard = function (_a) {
    var _b;
    ...
    var _c = (0, react_1.useState)(''), respirationRateValueText = _c[0], setRespirationRateValueText = _c[1];
    var _d = (0, react_1.useState)(false), isRespirationRateValidationError = _d[0], setRespirationRateValidationError = _d[1];
    ...
    var isDisabledAddButton = !respirationRateValueText || isRespirationRateValidationError;
    var latestRespRateValue = (_b = currentObs[0]) === null || _b === void 0 ? void 0 : _b.value;
    var handleSaveRespirationRateObservation = (0, react_1.useCallback)(function (respRateValueText) { return __awaiter(void 0, void 0, void 0, function () {
        var respRateValueNumber, vitalObs, _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    respRateValueNumber = (0, helpers_1.textToRespirationRateNumber)(respRateValueText);
                    if (!respRateValueNumber)
                        return [2 /*return*/];
                    _b.label = 1;
                case 1:
                ...
                case 3:
                    _a = _b.sent();
                    (0, notistack_1.enqueueSnackbar)('Error saving respiration rate data', { variant: 'error' });
                    return [3 /*break*/, 5];
                case 4:
                    setIsSaving(false);
                    return [7 /*endfinally*/];
    ...
    var handleTextInputChange = (0, react_1.useCallback)(function (e) {
        var respirationRateAsText = e.target.value;
    ...
    return (<material_1.Box sx={{ mt: 3 }}>
      <components_1.AccordionCard label={"RR (/min) ".concat(latestRespRateValue !== null && latestRespRateValue !== void 0 ? latestRespRateValue : '')} collapsed={isCollapsed} onSwitch={handleSectionCollapse}>
        <components_1.DoubleColumnContainer divider leftColumn={<material_1.Grid container sx={{
              ...
              <material_1.Grid item xs={12} sm={6} md={6} lg={6} order={{ xs: 1, sm: 1, md: 1 }}>
                <VitalsTextInputFiled_1.VitalsTextInputFiled label="RR (/min)" value={respirationRateValueText} disabled={isSaving} isInputError={isRespirationRateValidationError} onChange={handleTextInputChange}/>
              </material_1.Grid>

              {/* Add Button column */}
              <material_1.Grid item xs={12} sm={6} md={6} lg={6} order={{ xs: 2, sm: 2, md: 2, lg: 2 }} sx={{ mt: 0 }}>
                <RoundedButton_1.RoundedButton size="small" disabled={isDisabledAddButton} loading={isSaving} onClick={function () { return handleSaveRespirationRateObservation(respirationRateValueText); }} color="primary" sx={{
                height: '40px',
                px: 2,
                ml: 1,
            }}>
...
exports.default = VitalsRespirationRateCard;
//# sourceMappingURL=VitalsRespirationRateCard.js.map