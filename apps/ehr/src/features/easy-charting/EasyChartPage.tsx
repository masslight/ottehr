...
export default function EasyChartPage(): JSX.Element {
  ...
  // This page hosts an Ambient Scribe recorder (the Fab below); keep the recording alive across
  // rotation and stop & save it on leaving the page (required of every recorder host).
  useStopAmbientScribeOnLeave({ hostKey: encounterId ?? '' });
