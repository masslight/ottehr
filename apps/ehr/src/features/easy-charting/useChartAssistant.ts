...
export function useChartAssistant({
  ...
  // Which path a typed message takes — see looksLikeNarrative in intent-logic (kept there so the
  // routing rule is unit-testable rather than buried in this hook).
