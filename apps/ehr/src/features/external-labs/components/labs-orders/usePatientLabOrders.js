...
exports.usePatientLabOrders = void 0;
...
var useDeleteCommonLabOrderDialog_1 = require("../../../common/useDeleteCommonLabOrderDialog");
var usePatientLabOrders = function (_searchBy) {
    ...
    var _e = (0, react_1.useState)([]), patientLabItems = _e[0], setPatientLabItems = _e[1];
    /**
    ...
    var fetchLabOrders = (0, react_1.useCallback)(function (searchParams) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, (0, api_1.getExternalLabOrders)(oystehrZambda, searchParams)];
                case 3:
                    response = _a.sent();
                    return [3 /*break*/, 5];
                case 4:
                    ...
                    console.error('Error fetching external lab orders:', err_1);
                ...
                case 6:
                    error_1 = _a.sent();
                    console.error('error with setting external lab orders:', error_1);
    ...
    (0, react_1.useEffect)(function () {
        ...
        var params = __assign(__assign(__assign({ itemsPerPage: utils_1.DEFAULT_LABS_ITEMS_PER_PAGE }, memoizedSearchBy), (testTypeFilterRef.current && { orderableItemCode: testTypeFilterRef.current })), (visitDateFilterRef.current &&
    ...
    var handleDeleteLabOrder = (0, react_1.useCallback)(function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
        var deleteParams, err_2, errorObj;
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, (0, api_1.deleteLabOrder)(oystehrZambda, deleteParams)];
                case 2:
                    _c.sent();
                ...
                case 3:
                    err_2 = _c.sent();
                    console.error('Error deleting external lab order:', err_2);
    ...
    var markTaskAsReviewed = (0, react_1.useCallback)(function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
        var taskId = _b.taskId, serviceRequestId = _b.serviceRequestId, diagnosticReportId = _b.diagnosticReportId, appointmentId = _b.appointmentId;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    if (!oystehrZambda) {
                    ...
                    setLoading(true);
                    return [4 /*yield*/, (0, api_1.updateLabOrderResources)(oystehrZambda, { taskId: taskId, serviceRequestId: serviceRequestId, diagnosticReportId: diagnosticReportId, event: 'reviewed' })];
                case 1:
                    _c.sent();
                    setSearchParams({ pageNumber: 1 });
                    navigate((0, helpers_1.getExternalLabOrdersUrl)(appointmentId));
                    return [2 /*return*/];
            }
        });
    }); }, [oystehrZambda, setSearchParams, navigate]);
    var saveSpecimenDate = (0, react_1.useCallback)(function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
        var specimenId = _b.specimenId, date = _b.date, serviceRequestId = _b.serviceRequestId;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    if (!oystehrZambda) {
                    ...
                    return [4 /*yield*/, (0, api_1.updateLabOrderResources)(oystehrZambda, {
...
exports.usePatientLabOrders = usePatientLabOrders;
//# sourceMappingURL=usePatientLabOrders.js.map