...
import { AdditionalQuestionsPatientColumn } from 'src/components/AdditionalQuestions/AdditionalQuestionsPatientColumn';
import { AdditionalQuestionsProviderColumn } from 'src/components/AdditionalQuestions/AdditionalQuestionsProviderColumn';
