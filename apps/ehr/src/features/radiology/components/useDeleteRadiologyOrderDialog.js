...
exports.useDeleteRadiologyOrderDialog = void 0;
var material_1 = require("@mui/material");
var react_1 = require("react");
var useDeleteRadiologyOrderDialog = function (_a) {
    var deleteOrder = _a.deleteOrder;
    var _b = (0, react_1.useState)(false), isDeleteDialogOpen = _b[0], setIsDeleteDialogOpen = _b[1];
    var _c = (0, react_1.useState)(false), isDeleting = _c[0], setIsDeleting = _c[1];
    var _d = (0, react_1.useState)(null), deleteError = _d[0], setDeleteError = _d[1];
    var _e = (0, react_1.useState)(''), serviceRequestIdToDelete = _e[0], setServiceRequestIdToDelete = _e[1];
    var _f = (0, react_1.useState)(''), studyTypeToDelete = _f[0], setStudyTypeToDelete = _f[1];
    var showDeleteRadiologyOrderDialog = (0, react_1.useCallback)(function (_a) {
        var serviceRequestId = _a.serviceRequestId, studyType = _a.studyType;
    ...
    var confirmDeleteOrder = (0, react_1.useCallback)(function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    err_1 = _a.sent();
                    console.error('Error confirming delete:', err_1);
                    errorMessage = err_1 instanceof Error ? err_1.message : 'An error occurred during deletion';
...
exports.useDeleteRadiologyOrderDialog = useDeleteRadiologyOrderDialog;
//# sourceMappingURL=useDeleteRadiologyOrderDialog.js.map