...
import { useGetErxConfigQuery } from 'src/features/telemed/hooks/useGetErxConfig';
import { addSpacesAfterCommas } from 'src/helpers/formatString';
import { adjustTopForBannerHeight } from 'src/helpers/misc.helper';
import { useGetTelemedAppointmentWithSMSModel } from 'src/shared/hooks/appointment/appointment.queries';
import {
  useAppointmentData,
...
import { getAppointmentStatusChip, quickTexts } from '../../utils';
