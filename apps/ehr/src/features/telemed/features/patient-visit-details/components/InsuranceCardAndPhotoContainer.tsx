...
import DownloadImagesButton from 'src/components/DownloadImagesButton';
import ImageCarousel, { ImageCarouselObject } from 'src/components/ImageCarousel';
import { useGetDocumentReferences } from 'src/shared/hooks/appointment/appointment.queries';
import { useAppointmentData } from 'src/shared/hooks/appointment/appointment.store';
import { DocumentInfo, DocumentType } from 'src/types/types';
