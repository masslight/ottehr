...
import { roundTemperatureValue } from 'utils/lib/helpers/vitals/vitals-temperature.helper';
import { VitalTemperatureObservationMethod } from 'utils/lib/types/api/chart-data/chart-data.constants';
