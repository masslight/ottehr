...
const VitalsWeightsCard: React.FC<VitalsWeightsCardProps> = ({ field, variant = 'card' }): JSX.Element => {
            ...
            label={
              <Typography
                sx={{
                  fontSize: '16px',
                  fontWeight: 500,
                  color: field.isSaving ? lighten(theme.palette.text.primary, 0.4) : theme.palette.text.primary,
                }}
              >
                Patient Refused
              </Typography>
