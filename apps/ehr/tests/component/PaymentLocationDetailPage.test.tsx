...
describe('PaymentLocationDetailPage', () => {
  ...
  it('renders location detail sections when data is loaded', () => {
    mockPaymentLocationsData.mockReturnValue({
      data: [{ location: makeLocation(), supportsVirtualVisits: false, stripeTerminalLocationId: undefined }],
      isLoading: false,
    });
  ...
  it('shows "Virtual Visits Supported" chip when applicable', () => {
    mockPaymentLocationsData.mockReturnValue({
      data: [{ location: makeLocation(), supportsVirtualVisits: true, stripeTerminalLocationId: undefined }],
      isLoading: false,
    });
  ...
  it('renders "No address on file" when location has no address', () => {
    ...
    mockPaymentLocationsData.mockReturnValue({
      data: [{ location: loc, supportsVirtualVisits: false, stripeTerminalLocationId: undefined }],
      isLoading: false,
    });
