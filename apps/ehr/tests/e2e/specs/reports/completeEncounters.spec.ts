...
test.describe('Complete Encounters Report', () => {
  test('Reports page shows the Complete Encounters tile', async () => {
  ...
  test('Complete Encounters report page renders heading and description', async () => {
  ...
  test('Date range selector is visible and defaults to Today', async () => {
    await page.goto('/reports/complete-encounters');
    ...
    await expect(dateRangeSelect).toContainText('Today');
  });
