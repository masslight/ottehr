...
var TelemedAssessmentPage_1 = require("../../page/telemed/TelemedAssessmentPage");
var TelemedProgressNotePage_1 = require("../../page/telemed/TelemedProgressNotePage");
var PROCESS_ID = "assessmentTab.spec.ts-telemed-".concat(luxon_1.DateTime.now().toMillis());
...
test_1.test.beforeAll(function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 2:
                page = _c.sent();
                assessmentPage = new TelemedAssessmentPage_1.TelemedAssessmentPage(page);
                progressNotePage = new TelemedProgressNotePage_1.TelemedProgressNotePage(page);
                ...
                return [4 /*yield*/, test_1.test.step('Select E&M code', function () { return __awaiter(void 0, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 1:
                                    _a.sent();
                                    return [4 /*yield*/, (0, test_utils_1.waitForSaveChartDataResponse)(page, function (json) { var _a; return ((_a = json.chartData.emCode) === null || _a === void 0 ? void 0 : _a.code) === E_M_CODE; })];
                                case 2:
                                    _a.sent();
                                    return [2 /*return*/];
                            }
                ...
                return [4 /*yield*/, test_1.test.step('Verify E&M code is added', function () { return __awaiter(void 0, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 2:
                                    _a.sent();
                                    return [4 /*yield*/, (0, test_1.expect)(page.getByText(E_M_CODE)).toBeVisible()];
                                case 3:
                                    _a.sent();
                                    return [2 /*return*/];
                            }
