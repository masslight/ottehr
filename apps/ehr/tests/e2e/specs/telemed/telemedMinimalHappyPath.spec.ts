...
test.describe('Telemed minimal happy path', { tag: '@flaky' }, () => {
  ...
  test('Should fill all required fields', async () => {
    ...
    const patientInfoConfirmationCheckbox = page.getByTestId(
      dataTestIds.telemedEhrFlow.patientInfoConfirmationCheckbox
    );
...
}); // end Telemed minimal happy path
