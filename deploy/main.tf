...
module "ottehr_apps" {
  ...
  ehr_vars = {
    ...
    IS_LEGACY_PATIENT_FOLLOWUPS_ENABLED_FEATURE_FLAG = module.oystehr.IS_LEGACY_PATIENT_FOLLOWUPS_ENABLED_FEATURE_FLAG
    SKIP_SENDING_VISIT_NOTE_TO_PATIENT_PORTAL_WHEN_THE_NOTE_IS_SIGNED_FEATURE_FLAG = module.oystehr.SKIP_SENDING_VISIT_NOTE_TO_PATIENT_PORTAL_WHEN_THE_NOTE_IS_SIGNED_FEATURE_FLAG
