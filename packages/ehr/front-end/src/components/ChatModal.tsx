...
const ChatModal = (): ReactElement => {
  ...
  const quickTexts = [
    ...
    `Please complete the paperwork and sign consent forms to avoid a delay in check-in. For ${currentOpenChat?.patientParticipant.firstName}, click here: ${VITE_APP_QRS_URL}/appointment/${currentOpenChat?.patientParticipant.appointmentId}`,
    ...
    `Ottehrs are trying to get ahold of you. Please call us at ${officePhoneNumber} or respond to this text message.`,
  ];
