...
ZIP_ORDER=('get-patients' 'get-paperwork' 'create-paperwork' 'update-paperwork' 'create-appointment' 'get-appointments' 'cancel-appointment' 'get-wait-status' 'join-call' 'video-chat-invites-create' 'video-chat-invites-cancel' 'video-chat-invites-list' 'get-presigned-file-url' 'payment-methods-setup' 'payment-methods-list' 'payment-methods-set-default' 'payment-methods-delete')
