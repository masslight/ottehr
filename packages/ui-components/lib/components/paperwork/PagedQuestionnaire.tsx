...
import { PaperworkThemeProvider, usePaperworkOtherColors } from './theme';
...
const PagedQuestionnaire: FC<PagedQuestionnaireInput> = ({
  ...
  const methods = useForm<QuestionnaireFormFields>({
    ...
    resolver: skipValidation ? undefined : yupResolver(validationSchema, { abortEarly: false }),
  });
  const { reset } = methods;
