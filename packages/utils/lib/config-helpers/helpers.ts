...
export enum CONFIG_INJECTION_KEYS {
  ...
  EXAMINATION = '__TEST_EXAMINATION_CONFIG__',
  VITALS = '__TEST_VITALS_CONFIG__',
  PROCEDURES = '__TEST_PROCEDURES_CONFIG__',
  MEDICAL_HISTORY = '__TEST_MEDICAL_HISTORY_CONFIG__',
  VALUE_SETS = '__TEST_VALUE_SETS_CONFIG__',
  PATIENT_RECORD = '__TEST_PATIENT_RECORD_CONFIG__',
  PROVIDER = '__TEST_PROVIDER_CONFIG__',
}
