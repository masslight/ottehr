...
import {
  ...
  CODE_SYSTEM_ZAPEHR_RCM_CMS1500_REFERRING_PROVIDER_TYPE,
  CODE_SYSTEM_ZAPEHR_RCM_CMS1500_RESUBMISSION_RELATIONSHIP,
...
function referringProviderRole(qualifier: string): CodeableConcept {
  ...
  return codeableConcept(code, CODE_SYSTEM_ZAPEHR_RCM_CMS1500_REFERRING_PROVIDER_TYPE);
}
