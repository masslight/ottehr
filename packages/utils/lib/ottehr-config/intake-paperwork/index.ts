...
export const IN_PERSON_INTAKE_PAPERWORK_VERSION = '1.2.2';
    ...
    consentForms: {
      ...
      items: {
        checkboxGroup: {
          ...
          type: 'group',
          // items and requiredFields are populated dynamically in getIntakePaperworkConfig
          // based on the current consent forms config (picks up test overrides)
          items: {},
          requiredFields: [],
        },
        signature: {
...
export function getIntakePaperworkConfig(consentFormsConfig?: ResolvedConsentFormConfig[]): PaperworkConfig {
  ...
  // Build dynamic consent forms section with current consent forms
