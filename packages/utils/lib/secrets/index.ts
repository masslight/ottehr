...
export enum SecretsKeys {
  ...
  INVOICING_DEFAULT_SMS_MESSAGE = 'INVOICING_DEFAULT_SMS_MESSAGE',
  INVOICING_DEFAULT_MEMO_MESSAGE = 'INVOICING_DEFAULT_MEMO_MESSAGE',
  INVOICING_DEFAULT_DUE_DATE_IN_DAYS = 'INVOICING_DEFAULT_DUE_DATE_IN_DAYS',
