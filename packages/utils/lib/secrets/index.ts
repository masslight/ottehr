...
export enum SecretsKeys {
  ...
  PATIENT_VITAL_ERROR_TEMPLATE_EMAIL_TEMPLATE_ID = 'PATIENT_VITAL_ERROR_TEMPLATE_EMAIL_TEMPLATE_ID',
  PATIENT_VITAL_WARNING_TEMPLATE_EMAIL_TEMPLATE_ID = 'PATIENT_VITAL_WARNING_TEMPLATE_EMAIL_TEMPLATE_ID',
