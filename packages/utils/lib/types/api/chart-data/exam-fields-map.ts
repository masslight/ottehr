...
export const inPersonExamCardsMap: { [field in InPersonExamCardsNames]: SNOMEDCodeConceptInterface } = {
  'general-comment': {
    code: createCodingCode('38266002', 'Entire body as a whole (body structure)'),
  },
  'skin-comment': {
...
export const inPersonExamFieldsMap: { [field in InPersonExamFieldsNames]: SNOMEDCodeConceptInterface | undefined } = {
  // >>> CARD = general
  'well-appearing': {
    code: createCodingCode('000000001', 'Dummy SNOMED code'),
  },
