...
export interface CreateProcedureQuickPickInput {
  quickPick: Omit<ProcedureQuickPickData, 'id'>;
}

export interface CreateProcedureQuickPickResponse {
  message: string;
  quickPick: ProcedureQuickPickData;
}

export interface UpdateProcedureQuickPickInput {
  quickPickId: string;
  quickPick: Omit<ProcedureQuickPickData, 'id'>;
}

export interface UpdateProcedureQuickPickResponse {
  message: string;
  quickPick: ProcedureQuickPickData;
}
...
export interface RemoveProcedureQuickPickInput {
  quickPickId: string;
}

export interface RemoveProcedureQuickPickResponse {
  message: string;
}
