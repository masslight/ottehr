...
export enum SecretsKeys {
  ...
  STRIPE_SECRET_KEY_LIVE_MODE = 'STRIPE_SECRET_KEY_LIVE_MODE',
  STRIPE_PUBLISHABLE_KEY_LIVE_MODE = 'STRIPE_PUBLISHABLE_KEY_LIVE_MODE',
  STRIPE_SECRET_KEY_TEST_MODE = 'STRIPE_SECRET_KEY_TEST_MODE',
  STRIPE_PUBLISHABLE_KEY_TEST_MODE = 'STRIPE_PUBLISHABLE_KEY_TEST_MODE',
