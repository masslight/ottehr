import {
  GetBillingProvidersInput,
  GetBillingProvidersInputSchema,
  INVALID_INPUT_ERROR,
  MISSING_REQUEST_BODY,
} from 'utils';
import { formatZodError, ZambdaInput } from '../../shared';

export interface GetBillingProvidersParams extends GetBillingProvidersInput {
...
export function validateRequestParameters(input: ZambdaInput): GetBillingProvidersParams {
  ...
  const result = GetBillingProvidersInputSchema.safeParse(raw);
