...
export const index = makeCreateHandler('admin-create-radiology-quick-pick', RADIOLOGY_QUICK_PICK_CATEGORY, (body) => {
  ...
  return { quickPick: quickPick as Omit<RadiologyQuickPickData, 'id'> };
});
