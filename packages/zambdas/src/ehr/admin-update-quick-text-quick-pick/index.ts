...
export const index = makeUpdateHandler('admin-update-quick-text-quick-pick', QUICK_TEXT_QUICK_PICK_CATEGORY, (body) => {
  ...
  return { quickPickId, quickPick: quickPick as Omit<QuickTextQuickPickData, 'id'> };
});
