...
function deleteResourceRequest(resourceType, resourceId) {
    return { method: 'DELETE', url: "/".concat(resourceType, "/").concat(resourceId) };
}
function updateResourceRequest(resource) {
    if (!resource.id)
        throw new Error('A resource must have an ID in order to be updated');
    return {
        method: 'PUT',
