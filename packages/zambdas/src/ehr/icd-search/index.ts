...
import { wrapHandler } from '../../shared';
...
export const index = wrapHandler(ZAMBDA_NAME, async (): Promise<APIGatewayProxyResult> => {
  return {
    statusCode: 501,
    body: 'ICD Search Lambda has been deprecated',
  };
});
