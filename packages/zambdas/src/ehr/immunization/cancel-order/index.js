...
var m2mToken;
var ZAMBDA_NAME = 'cancel-immunization-order';
exports.index = (0, shared_1.wrapHandler)(ZAMBDA_NAME, function (input) { return __awaiter(void 0, void 0, void 0, function () {
    var validatedParameters, oystehr, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, cancelImmunizationOrder(oystehr, validatedParameters)];
            case 2:
                _a.sent();
                return [2 /*return*/, {
                        statusCode: 200,
...
function cancelImmunizationOrder(oystehr, input) {
    return __awaiter(this, void 0, void 0, function () {
        var orderId, medicationAdministration, currentStatus, patchOperations;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    ...
                    if (medicationAdministration.status !== 'in-progress') {
                        ...
                        throw new Error("Can't cancel order in \"".concat(currentStatus, "\" status"));
                    }
                    patchOperations = [(0, utils_1.replaceOperation)('/status', (0, utils_1.mapOrderStatusToFhir)('cancelled'))];
...
function validateRequestParameters(input) {
    var orderId = (0, shared_1.validateJsonBody)(input).orderId;
    if (!orderId) {
