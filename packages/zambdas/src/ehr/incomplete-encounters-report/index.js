...
var m2mToken;
var ZAMBDA_NAME = 'incomplete-encounters-report';
exports.index = (0, shared_1.wrapHandler)(ZAMBDA_NAME, function (input) { return __awaiter(void 0, void 0, void 0, function () {
    var validatedParameters, dateRange, secrets, oystehr, allResources, offset, pageSize, baseSearchParams, searchBundle, pageCount, pageResources, pageAppointments, pageAppointmentsCount, encounters, appointments, patients, locations, practitioners, appointmentMap_1, patientMap_1, locationMap_1, practitionerMap_1, incompleteEncounters, encounterItems, response, error_1, ENVIRONMENT;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                dateRange = validatedParameters.dateRange, secrets = validatedParameters.secrets;
                console.groupEnd();
            ...
            case 2:
                ...
                pageCount = 1;
                console.log("Fetching page ".concat(pageCount, " of incomplete encounters..."));
            ...
            case 5:
                ...
                console.log("Encounters: ".concat(encounters.length, ", Appointments: ").concat(appointments.length, ", Patients: ").concat(patients.length, ", Locations: ").concat(locations.length, ", Practitioners: ").concat(practitioners.length));
                ...
                incompleteEncounters = encounters.filter(function (encounter) {
                    var _a, _b;
                    ...
                    // Get visit status
                    var visitStatus = (0, utils_1.getInPersonVisitStatus)(appointment, encounter, true);
                    // Terminal states that should be excluded from the report
                    var terminalStates = ['completed', 'cancelled', 'no-show'];
                    return !terminalStates.includes(visitStatus);
                });
                console.log("Found ".concat(incompleteEncounters.length, " incomplete encounters"));
                encounterItems = incompleteEncounters.map(function (encounter) {
                    ...
                    var attendingProviderName = attendingPractitioner
                        ? "".concat(((_j = (_h = (_g = attendingPractitioner.name) === null || _g === void 0 ? void 0 : _g[0]) === null || _h === void 0 ? void 0 : _h.given) === null || _j === void 0 ? void 0 : _j[0]) || '', " ").concat(((_l = (_k = attendingPractitioner.name) === null || _k === void 0 ? void 0 : _k[0]) === null || _l === void 0 ? void 0 : _l.family) || '').trim()
                        : 'Unknown';
                    ...
                    return {
                        ...
                        visitType: visitType,
                        reason: ((_o = (_m = encounter.reasonCode) === null || _m === void 0 ? void 0 : _m[0]) === null || _o === void 0 ? void 0 : _o.text) || ((_p = appointment === null || appointment === void 0 ? void 0 : appointment.appointmentType) === null || _p === void 0 ? void 0 : _p.text) || '',
                    };
                });
                response = {
                    message: "Found ".concat(encounterItems.length, " incomplete encounters"),
