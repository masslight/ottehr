import { GetPrintingConfigInput, INVALID_INPUT_ERROR, MISSING_REQUEST_BODY, Secrets } from 'utils';
import { z } from 'zod';
...
export function validateRequestParameters(
  input: ZambdaInput
): GetPrintingConfigInput & { secrets: Secrets | null; userToken: string } {
  if (!input.body) {
  ...
  let params: GetPrintingConfigInput;
  try {
