...
var validateInput = function (input, oystehr) { return __awaiter(void 0, void 0, void 0, function () {
    var serviceRequest, callerAccessToken;
...
var validateSecrets = function (secrets) {
    ...
    var ADVAPACS_CLIENT_ID = secrets.ADVAPACS_CLIENT_ID, ADVAPACS_CLIENT_SECRET = secrets.ADVAPACS_CLIENT_SECRET, ADVAPACS_VIEWER_USERNAME = secrets.ADVAPACS_VIEWER_USERNAME, AUTH0_ENDPOINT = secrets.AUTH0_ENDPOINT, AUTH0_CLIENT = secrets.AUTH0_CLIENT, AUTH0_SECRET = secrets.AUTH0_SECRET, AUTH0_AUDIENCE = secrets.AUTH0_AUDIENCE, FHIR_API = secrets.FHIR_API, PROJECT_API = secrets.PROJECT_API;
