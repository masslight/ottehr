...
var ZAMBDA_NAME = 'get-past-visits';
// Lifting up value to outside of the handler allows it to stay in memory across warm lambda invocations
var oystehrToken;
exports.index = (0, shared_1.wrapHandler)(ZAMBDA_NAME, function (input) { return __awaiter(void 0, void 0, void 0, function () {
    var validatedParameters, patientId, secrets, fhirAPI, projectAPI, oystehr, user, patients, patientIDs, allResources_1, scheduleResource_1, locations_1, encountersMap_1, appointments_1, pastVisitStatuses_1, response, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 4:
                ...
                scheduleResource_1 = allResources_1.filter(function (resource) {
                    if (resource.resourceType !== 'Schedule')
                        return false;
                    var extensionTemp = resource.extension;
                    var extensionSchedule = extensionTemp === null || extensionTemp === void 0 ? void 0 : extensionTemp.find(function (extension) { return extension.url === utils_1.TIMEZONE_EXTENSION_URL; });
                ...
                encountersMap_1 = (0, helpers_1.mapEncountersToAppointmentIds)(allResources_1);
                appointments_1 = [];
                pastVisitStatuses_1 = ['fulfilled', 'cancelled'];
                allResources_1
                    ...
                    if (!fhirAppointment.id)
                        return;
                    if (!pastVisitStatuses_1.includes(fhirAppointment.status))
                        return;
                    ...
                    var timezone = scheduleResource_1 ? (0, utils_1.getTimezone)(scheduleResource_1) : utils_1.TIMEZONES[0];
                    var appointmentTypeTag = (_j = (_h = fhirAppointment.meta) === null || _h === void 0 ? void 0 : _h.tag) === null || _j === void 0 ? void 0 : _j.find(function (tag) { return tag.code && tag.code in utils_1.appointmentTypeMap; });
                    var appointmentType = (appointmentTypeTag === null || appointmentTypeTag === void 0 ? void 0 : appointmentTypeTag.code) ? utils_1.appointmentTypeMap[appointmentTypeTag.code] : 'Unknown';
                    var status;
                    if (appointmentType === 'Telemedicine') {
                        status = (0, utils_1.getTelemedVisitStatus)(encounter.status, fhirAppointment.status);
                    }
                    else if (appointmentType === 'In-Person') {
                        status = (0, utils_1.getInPersonVisitStatus)(fhirAppointment, encounter);
                    }
                    if (!status) {
                    ...
                    var appointment = {
                        ...
                        patient: {
                            ...
                            firstName: (_m = (_l = (_k = patient === null || patient === void 0 ? void 0 : patient.name) === null || _k === void 0 ? void 0 : _k[0]) === null || _l === void 0 ? void 0 : _l.given) === null || _m === void 0 ? void 0 : _m[0],
                            lastName: (_o = patient === null || patient === void 0 ? void 0 : patient.name) === null || _o === void 0 ? void 0 : _o[0].family,
                        },
                ...
                response = {
                    appointments: appointments_1.sort(function (a, b) { return new Date(b.start || '').getTime() - new Date(a.start || '').getTime(); }),
                };
                return [2 /*return*/, {
                        statusCode: 200,
