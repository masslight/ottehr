...
exports.filterTelemedVideoEncounters = filterTelemedVideoEncounters;
exports.getFhirResources = getFhirResources;
var utils_1 = require("utils");
function filterTelemedVideoEncounters(allResources) {
    var result = {};
    allResources.forEach(function (resource) {
        var _a;
        if (!(resource.resourceType === 'Encounter' && (0, utils_1.getVideoRoomResourceExtension)(resource)))
            return;
