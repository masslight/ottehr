...
exports.index = (0, shared_1.wrapHandler)('patch-paperwork', function (input) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                ...
                return [4 /*yield*/, (0, validateRequestParameters_1.validatePatchInputs)(input, oystehr)];
            case 4:
                effectInput = _a.sent();
            ...
            case 6:
                ...
                return [2 /*return*/, (0, shared_1.topLevelCatch)('patch-paperwork', error_1, ENVIRONMENT)];
            case 7: return [2 /*return*/];
        }
    });
}); });
var performEffect = function (input, oystehr) { return __awaiter(void 0, void 0, void 0, function () {
    var updatedAnswers, questionnaireResponseId, currentQRStatus, patchIndex, operations;
    return __generator(this, function (_a) {
        updatedAnswers = input.updatedAnswers, questionnaireResponseId = input.questionnaireResponseId, currentQRStatus = input.currentQRStatus, patchIndex = input.patchIndex;
        console.log('patchIndex:', patchIndex);
        console.log('updatedAnswers', JSON.stringify(updatedAnswers));
        operations = [
            {
                op: 'add',
                path: "/item/".concat(patchIndex, "/item"),
