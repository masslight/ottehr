...
exports.index = (0, shared_1.wrapHandler)('payment-set-default', function (input) { return __awaiter(void 0, void 0, void 0, function () {
    var validatedParameters, beneficiaryPatientId, paymentMethodId, appointmentId, secrets, oystehrClient, stripeCustomerId, stripeClient, stripeAccount, customer, stripeError_1, error_1, ENVIRONMENT;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                beneficiaryPatientId = validatedParameters.beneficiaryPatientId, paymentMethodId = validatedParameters.paymentMethodId, appointmentId = validatedParameters.appointmentId, secrets = validatedParameters.secrets;
                console.groupEnd();
            ...
            case 7:
                _a.trys.push([7, 9, , 10]);
                return [4 /*yield*/, stripeClient.customers.update(stripeCustomerId, {
                        invoice_settings: {
            ...
            case 10: return [2 /*return*/, (0, shared_1.lambdaResponse)(200, {})];
            case 11:
                error_1 = _a.sent();
                console.error(error_1);
                ENVIRONMENT = (0, utils_1.getSecret)(utils_1.SecretsKeys.ENVIRONMENT, input.secrets);
                return [2 /*return*/, (0, shared_1.topLevelCatch)('payment-methods-set-default', error_1, ENVIRONMENT)];
