...
function validateRequestParameters(input) {
    ...
    var _a = JSON.parse(input.body), beneficiaryPatientId = _a.beneficiaryPatientId, paymentMethodId = _a.paymentMethodId, appointmentId = _a.appointmentId;
...
function complexValidation(input) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, (0, helpers_1.getStripeCustomerId)(input)];
        });
    });
}
