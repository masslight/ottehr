...
function createGlobalTemplateFromAppointment(config, appointmentId, title) {
                ...
                case 2:
                    ...
                    appointmentBundle.entry = appointmentBundle.entry.filter(function (entry) {
                        ...
                        if (((_a = entry.resource) === null || _a === void 0 ? void 0 : _a.resourceType) === 'Condition')
                            return true; // We do want multiple ICD-10 codes though!
                    ...
                    for (_i = 0, _a = appointmentBundle.entry; _i < _a.length; _i++) {
                        ...
                        if (entry.resource.resourceType === 'Encounter')
                            continue;
                        anonymizedResource = entry.resource;
                    ...
                    return [2 /*return*/, listToCreate];
            }
        });
    });
}
function processGlobalTemplatesFromCSV(config) {
    return __awaiter(this, void 0, void 0, function () {
        var csvPath, csvContent, csvData, results, _i, csvData_1, row, title, appointmentId, list, key, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    csvPath = path.join(__dirname, 'data/templates/adult-templates.csv');
                ...
                case 1:
                    ...
                    if (!title || !appointmentId) {
                        console.log("Skipping row due to missing title or appointment-id: ".concat(JSON.stringify(row)));
                        return [3 /*break*/, 5];
                    }
                    _a.label = 2;
                case 2:
                    _a.trys.push([2, 4, , 5]);
                    console.log("Processing: ".concat(title, " (").concat(appointmentId, ")"));
                    return [4 /*yield*/, createGlobalTemplateFromAppointment(config, appointmentId, title)];
                case 3:
                    list = _a.sent();
                ...
                case 4:
                    error_1 = _a.sent();
                    console.log("Error processing ".concat(title, ": ").concat(error_1));
                    return [3 /*break*/, 5];
                case 5:
                    _i++;
                    return [3 /*break*/, 1];
...
var main = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, (0, helpers_1.performEffectWithEnvFile)(processGlobalTemplatesFromCSV)];
            case 1:
                _a.sent();
                return [3 /*break*/, 3];
            case 2:
