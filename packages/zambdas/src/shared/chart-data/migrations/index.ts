...
export const MIGRATION_V1_FIELD_MAP: Record<string, { parent: string; label: string }> = {
  ...
  'murmur-iii': { parent: 'murmur-grade', label: 'Grade: Grade III' },
  'murmur-iv': { parent: 'murmur-grade', label: 'Grade: Grade IV' },
  'murmur-v': { parent: 'murmur-grade', label: 'Grade: Grade V' },
  'murmur-vi': { parent: 'murmur-grade', label: 'Grade: Grade VI' },

  // Lungs - Wheezing
  'wheezing-left-upper': { parent: 'wheezing', label: 'Location: Left upper' },
  'wheezing-left-lower': { parent: 'wheezing', label: 'Location: Left lower' },
  'wheezing-right-upper': { parent: 'wheezing', label: 'Location: Right upper' },
  'wheezing-right-middle': { parent: 'wheezing', label: 'Location: Right middle' },
  'wheezing-right-lower': { parent: 'wheezing', label: 'Location: Right lower' },

  // Lungs - Crackles
  'crackles-left-upper': { parent: 'crackles', label: 'Location: Left upper' },
  'crackles-left-lower': { parent: 'crackles', label: 'Location: Left lower' },
  'crackles-right-upper': { parent: 'crackles', label: 'Location: Right upper' },
  'crackles-right-middle': { parent: 'crackles', label: 'Location: Right middle' },
  'crackles-right-lower': { parent: 'crackles', label: 'Location: Right lower' },

  // Lungs - Decreased breath sounds
  'breath-sounds-left-upper': { parent: 'breath-sounds', label: 'Location: Left upper' },
  'breath-sounds-left-lower': { parent: 'breath-sounds', label: 'Location: Left lower' },
  'breath-sounds-right-upper': { parent: 'breath-sounds', label: 'Location: Right upper' },
  'breath-sounds-right-middle': { parent: 'breath-sounds', label: 'Location: Right middle' },
  'breath-sounds-right-lower': { parent: 'breath-sounds', label: 'Location: Right lower' },

  // Lungs - Retractions
  subcostal: { parent: 'retractions', label: 'Type: Subcostal' },
  suprasternal: { parent: 'retractions', label: 'Type: Suprasternal' },
  intercostal: { parent: 'retractions', label: 'Type: Intercostal' },

  // Abdomen - Tender
  diffusely: { parent: 'tender', label: 'Location: Diffusely' },
  ruq: { parent: 'tender', label: 'Location: RUQ' },
  rlq: { parent: 'tender', label: 'Location: RLQ' },
  luq: { parent: 'tender', label: 'Location: LUQ' },
  'r-cva': { parent: 'tender', label: 'Location: R CVA' },
  'l-cva': { parent: 'tender', label: 'Location: L CVA' },

  // Skin - old rash multi-select
  'cw-viral-exam': { parent: 'common-skin-findings', label: 'Rashes & Eruptions: Viral exanthem' },
  'cw-insect-bites': { parent: 'common-skin-findings', label: 'Rashes & Eruptions: Insect bites' },
  'cw-urticaria': { parent: 'common-skin-findings', label: 'Rashes & Eruptions: Urticaria' },
  'cw-coxsackievirus': { parent: 'common-skin-findings', label: 'Pediatric-Specific: Coxsackievirus' },
  'cw-irritant-diaper-rash': { parent: 'common-skin-findings', label: 'Pediatric-Specific: Irritant diaper rash' },
  'cw-ringworm': { parent: 'common-skin-findings', label: 'Rashes & Eruptions: Tinea' },
  'cw-impetigo': { parent: 'common-skin-findings', label: 'Rashes & Eruptions: Impetigo' },
  'cw-fifths-disease': { parent: 'common-skin-findings', label: "Pediatric-Specific: Fifth's disease" },
  'cw-atopic-dermatitis': { parent: 'common-skin-findings', label: 'Rashes & Eruptions: Eczema (atopic dermatitis)' },
  'cw-paronychia': { parent: 'common-skin-findings', label: 'Pediatric-Specific: Paronychia' },
  'cw-poison-ivy-contact-dermatitis': {
    parent: 'common-skin-findings',
    label: 'Rashes & Eruptions: Poison ivy contact dermatitis',
  },
  'cw-tinea-capitis': { parent: 'common-skin-findings', label: 'Pediatric-Specific: Tinea capitis' },
  'cw-pityriasis-rosea': { parent: 'common-skin-findings', label: 'Rashes & Eruptions: Pityriasis rosea' },
  'cw-lyme-ecm': { parent: 'common-skin-findings', label: 'Rashes & Eruptions: Erythema migrans' },
...
export function migrateV0ToV1(observations: ExamObservationDTO[]): MigrationResult {
  ...
  const parentGroups: Record<
    string,
    { components: { code: string; label: string; value: boolean }[]; resourceIds: string[] }
  > = {};
