...
exports.convertLabeConfigToPdfClientStyles = void 0;
exports.createExternalLabsLabelPDF = createExternalLabsLabelPDF;
...
var convertLabeConfigToPdfClientStyles = function (labelConfig) {
    var inchesToPoints = function (sizeInches) {
...
exports.convertLabeConfigToPdfClientStyles = convertLabeConfigToPdfClientStyles;
var createExternalLabsLabelPdfBytes = function (data) { return __awaiter(void 0, void 0, void 0, function () {
    var labelConfig, content, pdfClientStyles, pdfClient, CourierBold, Courier, baseFontSize, baseSpacing, textStyles, NEWLINE_Y_DROP, columnGapPoints, rightColumnXStart, drawHeaderAndInlineText, drawColumnRowAndNewline, patientLastName, patientFirstName, patientId, patientDateOfBirth, sampleCollectionDate, accountNumber, orderNumber;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                labelConfig = data.labelConfig, content = data.content;
                pdfClientStyles = (0, exports.convertLabeConfigToPdfClientStyles)(labelConfig);
            ...
            case 3:
                ...
                columnGapPoints = 0.0125;
                rightColumnXStart = pdfClientStyles.initialPage.width / 2 + columnGapPoints / 2;
                ...
                drawColumnRowAndNewline = function (leftColumn, rightColumn) {
                    var leftHeader = leftColumn.header ? "".concat(leftColumn.header, ": ") : '';
                    var startXPos = pdfClient.getLeftBound();
                    ...
                    var rightHeader = rightColumn.header ? "".concat(rightColumn.header, ": ") : '';
                ...
                patientLastName = content.patientLastName, patientFirstName = content.patientFirstName, patientId = content.patientId, patientDateOfBirth = content.patientDateOfBirth, sampleCollectionDate = content.sampleCollectionDate, accountNumber = content.accountNumber, orderNumber = content.orderNumber;
                pdfClient.drawTextSequential("".concat(patientLastName, ", ").concat(patientFirstName), __assign(__assign({}, textStyles.fieldHeader), { fontSize: textStyles.fieldHeader.fontSize + 1 }));
                pdfClient.newLine(NEWLINE_Y_DROP);
                drawHeaderAndInlineText('PID', patientId);
                pdfClient.newLine(NEWLINE_Y_DROP);
                drawColumnRowAndNewline({ header: 'DOB', value: patientDateOfBirth ? patientDateOfBirth.toFormat('MM/dd/yyyy') : '' }, { header: 'Coll', value: sampleCollectionDate ? sampleCollectionDate.toFormat('MM/dd/yyyy') : '' });
...
function createExternalLabsLabelPDFHelper(input, secrets, token) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, createExternalLabsLabelPdfBytes(input).catch(function (error) {
                ...
                case 1:
                    ...
                    fileName = "".concat(utils_1.EXTERNAL_LAB_LABEL_PDF_BASE_NAME, "-").concat(input.content.orderNumber, ".pdf");
                    ...
                    console.log('Uploading file to bucket, ', utils_1.BUCKET_NAMES.LABS);
                    _a.label = 2;
                case 2:
                    _a.trys.push([2, 5, , 6]);
...
function createExternalLabsLabelPDF(labelConfig, encounterId, serviceRequestID, secrets, token, oystehr) {
    return __awaiter(this, void 0, void 0, function () {
        var pdfInfo, docRefs, presignedURL;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, createExternalLabsLabelPDFHelper(labelConfig, secrets, token)];
                case 1:
                    pdfInfo = _b.sent();
                    ...
                    return [4 /*yield*/, (0, utils_1.createFilesDocumentReferences)({
                            ...
                            type: { coding: [utils_1.EXTERNAL_LAB_LABEL_DOC_REF_DOCTYPE], text: 'External lab sample label' },
                            references: {
                                subject: {
                            ...
                            oystehr: oystehr,
                            searchParams: [{ name: 'related', value: "ServiceRequest/".concat(serviceRequestID) }],
