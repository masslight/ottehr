...
function getRoleMembers(roleId, oystehr) {
    return __awaiter(this, void 0, void 0, function () {
        var cursor, COUNT, members, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    cursor = '';
                    COUNT = 100;
                    members = [];
                    console.log("search limit: ".concat(COUNT));
                    _a.label = 1;
                case 1: return [4 /*yield*/, oystehr.user.listV2({
                        cursor: cursor,
                        limit: COUNT,
                        roleId: roleId,
                        sort: 'name',
                ...
                case 2:
                    response = _a.sent();
                    members.push.apply(members, response.data);
