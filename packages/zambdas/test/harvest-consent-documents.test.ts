...
describe('createConsentResources', () => {
  const [HIPAA_FORM, CTT_FORM, CCOF_FORM] = getConsentFormsForLocation();
  ...
  test('creates, uploads, and files one PDF per configured consent form', async () => {
    ...
    // Both consent-to-treat and credit-card-agreement create Consent resources
  ...
  test('resolves consent form assets for Illinois (uses default paths, no state-specific override)', async () => {
