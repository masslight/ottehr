...
/**
 * Every field the save endpoint can persist that the sections hand back. Notes name their author the way
 * the EHR does (the signed-in practitioner): the server writes `Practitioner/<authorId>` into the note as
