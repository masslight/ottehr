...
import { groupCharacteristics, serviceCategoryCharacteristics } from 'utils/lib/fhir/healthcareService';
import { ListProviderGroupsResponse } from 'utils/lib/types/api/schedules';
