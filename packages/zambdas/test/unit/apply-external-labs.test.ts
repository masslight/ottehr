...
// Pin VALUE_SETS.externalLabCptCodesToAddPerEncounter to the value this suite was
// written against so tests are not affected by per-project config overlays.
