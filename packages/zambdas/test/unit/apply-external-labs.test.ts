...
// Derived from VALUE_SETS so tests skip automatically on overlays that omit this code
...
describe('collectExternalLabCptProcedures', () => {
  ...
  test.skipIf(!PER_ENCOUNTER_CPT_CODE)(
  ...
  describe.skipIf(!PER_ENCOUNTER_CPT_CODE)('per-encounter CPT code (e.g. 99001)', () => {
