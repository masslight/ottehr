...
import { index as rawIndex } from '../../../src/billing/update-billing-provider/index';
import { validateRequestParameters } from '../../../src/billing/update-billing-provider/validateRequestParameters';
...
describe('update-billing-provider', () => {
  ...
  describe('index', () => {
    ...
    it('overwrites the prior name on the fetched provider and returns its id', async () => {
