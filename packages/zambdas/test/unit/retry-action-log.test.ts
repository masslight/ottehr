...
// Pin skipSendingVisitNoteToPatientPortalEnabled to false so this test always exercises the
// email-retry path, regardless of the per-project overlay value for that flag.
