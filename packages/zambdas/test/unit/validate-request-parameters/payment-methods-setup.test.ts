...
import { validateRequestParameters } from '../../../src/patient/payment-methods/setup/validateRequestParameters';
import { createMockSecrets, createMockZambdaInput } from './helpers';

describe('payment-methods-setup - validateRequestParameters', () => {
