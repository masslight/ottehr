// Unit tests for the visit-note Procedures PDF section (shared by the progress note and the
// discharge summary): the structured wound/lesion size, repair depth, and infusion time fields
// compose to human-readable strings and render as labeled lines only when present.
...
describe('createProceduresSection — structured field lines', () => {
  ...
  it('draws no structured-field lines when the fields are absent', () => {
    ...
    // Sanity: the present fields still draw.
