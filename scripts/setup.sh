...
# Execute packages/zambdas/scripts/setup.ts with ts-node
display_progress "Executing packages/zambdas/scripts/setup.ts with ts-node..."
pnpx ts-node packages/zambdas/scripts/setup.ts
